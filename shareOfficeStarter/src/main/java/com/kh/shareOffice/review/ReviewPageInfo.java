...
public class ReviewPageInfo {
	...
	public ReviewPageInfo(int currentPage, int totalCount) {
		super();
		this.currentPage = currentPage;
		this.totalCount = totalCount;
	}

	public ReviewPageInfo(int currentPage, int boardLimit, int naviLimit, int startNavi, int endNavi, int totalCount,
			int maxPage) {
		super();
		this.currentPage = currentPage;
