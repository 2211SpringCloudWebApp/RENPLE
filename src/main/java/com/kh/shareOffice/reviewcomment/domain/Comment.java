package com.kh.shareOffice.reviewcomment.domain;
...
public class Comment {
	...
	public Comment(int commentNo, String userId, int reviewNo, String commentContent, Timestamp commentCreateDate,
