	...
	<div style="margin: 0 auto !important;
		...
		<form action="/reservation/admin/adminProductModify" method="POST">
			<table class="table table-hover" style="margin-top: 100px;">
				<tr>
					<td>번호</td>
					<td><input type="text" name="productNo" value="${product.productNo }" readonly="readonly"></td>
				</tr>
				<tr>
					<td>이름</td>
				...
				<tr>
					<td>최대인원</td>
					<td><input type="text" name="productUserMax" value="${product.productUserMax }"></td>
				</tr>
				<tr>
					<td>최소인원</td>
					<td><input type="text" name="productUserMin" value="${product.productUserMin }"></td>
				</tr>
				<tr>
					<td>등록일</td>
					<td><input type="text" name="pCreateDate" value="${product.pCreateDate }" readonly="readonly"></td>
				</tr>
				<tr>
					<td colspan="8">
