...
<body>
	...
	<form action="/reservation/detail/reservationModify" method="POST">
		<table class="table table-hover" style="margin-top: 100px;">
			...
			<tr>
				<td>요청사항</td>
				<td>
					<textarea cols="73" rows="7" name="orderRequest" style="resize: none;">${order.orderRequest }</textarea> 
				</td>
			</tr>
			<tr>
				<td colspan="2" align="center">
				   <input type="submit" value="수정하기" class="btn btn-primary">
			       <input type="button" value="예약취소" onclick="deleteCheck(${order.orderNo});" class='btn btn-danger'/>
	...
	<script type="text/javascript">
		function deleteCheck(orderNo){
			if(confirm("예약을 취소하시겠습니까?")){
				location.href="/reservation/delete?orderNo="+orderNo;
			} 
		}
	</script>
</body>
