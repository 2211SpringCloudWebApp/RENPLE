...
<body>
  ...
  <div id="container">
    ...
    <form id="form1" action="/payment" method="post">
        ...
        <div class="box-form-left">
          ...
          <div class="space-info">
            <div class="info-photo">
              <h4>여의도점</h4>
              <span><img src="/resources/img/reservation/reser_yeouido.jpg"></span>
              <p>
                1. 여의도역 3분 거리! <br>
          ...
          <ul class="list-detail">
            ...
            <li>
              ...
              <span class="data">최소 2명 ~ 최대 35명</span>
            </li>
          </ul>
            ...
            <ul>
              <li>
                ...
                <span class="info-pay-col2">
               	  <input type="number" name="orderUserCount" id="reservationUserCount" class="totalCount" max="35" min="2" placeholder="0명"
              ...
              <li id="pay-result">
                ...
                <span id="pay-result-right">200,000</span>
              </li>
            </ul>
      ...
      <input type="hidden" name="productNo" value="24">
  	...
  	function totalCount(){
  		...
  		inputNumber.addEventListener('input', () => {
  		  ...
  		  if (value < 2) {
  		    ...
  		    inputNumber.value = 35;
  		    alert('35보다 큰 값을 입력할 수 없습니다.');
  		  }
  		});
  	}
