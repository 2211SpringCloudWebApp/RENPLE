...
<body>
  ...
  <div id="container">
    ...
    <form id="form1" action="/payment" method="post">
        ...
        <div class="box-form-left">
          ...
          <div class="space-info">
            <div class="info-photo">
              <h4>구로점</h4>
              <span><img src="/resources/img/reservation/reser_gangnam1.jpg"></span>
              <p>
                1. 구로역 5분 거리! <br>
          ...
          <ul class="list-detail">
            ...
            <li>
              ...
              <span class="data">최소 2명 ~ 최대 60명</span>
            </li>
          </ul>
            ...
            <ul>
              <li>
                ...
                <span class="info-pay-col2">
               	  <input type="number" name="orderUserCount" id="reservationUserCount" class="totalCount" max="60" min="2" placeholder="0명"
      ...
      <input type="hidden" name="productNo" value="41">
