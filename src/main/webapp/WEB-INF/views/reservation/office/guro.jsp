    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="/resources/img/reservation/pc_guro1_main_2.png" class="rounded" >
        </div>
        <div class="carousel-item">
          <img src="/resources/img/reservation/pc_guro1_main_3.png" class="rounded" >
        </div>
        <div class="carousel-item">
          <img src="/resources/img/reservation/pc_guro1_main_4.png" class="rounded" >
        </div>
        <div class="carousel-item">
          <img src="/resources/img/reservation/pc_guro1_main_5.png" class="rounded" >
        </div>
      </div>
              ...
              <div id="detail-2-review-1">
                <a href="" target="_blank">
                  ...
                  <div>
                    ...
                    <p>
                      매일 쓰레기통도 비워 주셔서 사무실 청소에 신경 쓸 필요가 없고<br>
                       화장실까지 깨끗하게 관리되니 100점짜리 사무실입니다!
                    </p>
                      <span class="detail-span-bottom" style="border-right: 1px solid #e4e4e4; padding-right: 15px;">구로점</span>
                      <span class="detail-span-bottom" style="padding-left: 15px;">박소현님 </span>
                  </div>
                </a>  
              ...
              <div id="detail-2-review-2">
                <a href="" target="_blank">
                  ...
                  <div>
                    ...
                    <p>
                      3년 차 공유오피스 입주사가 자신 있게 추천! <br>
                      구로에서 공유오피스를 찾고 있다면 렌플이 답이다!
                    </p>
                      <span class="detail-span-bottom" style="border-right: 1px solid #e4e4e4; padding-right: 15px;">구로점</span>
                      <span class="detail-span-bottom" style="padding-left: 15px;">김하얀님 </span>
                  </div>
                </a>
